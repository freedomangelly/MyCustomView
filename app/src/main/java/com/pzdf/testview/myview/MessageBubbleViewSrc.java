...
public class MessageBubbleViewSrc extends View {
    // 两个圆的圆形
    ...
    public MessageBubbleViewSrc(Context context) {
        this(context, null);
    }

    public MessageBubbleViewSrc(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MessageBubbleViewSrc(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
